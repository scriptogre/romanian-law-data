"""
Stage 1 — extracts/soap.py

Fetch every act from `legislatie.just.ro` via its SOAP API (FreeWebService). Pages return 10
...
OUTPUT_PATH = Path(__file__).parent.parent.parent / "data" / "raw_acts.jsonl"
CURSOR_PATH = Path(__file__).parent.parent.parent / "data" / ".extract_cursor"
